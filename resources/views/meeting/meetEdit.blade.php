...
@section('title') @if($id=='new' ) @lang('info.addNewClass') @else @lang('info.editClass') @endif | @endsection
@section('subheader')  @if($id=='new' ) @lang('info.addNewClass') @else @lang('info.editClass') @endif @endsection
@section('style')
<style>
