    ...
    <div class=" col-md-6 col-sm-12">
        ...
        <div class="card card-custom gutter-b card-stretch">
            ...
            <div class="card-body text-center pt-4">
                ...
                <!--begin::User-->
                <div class="mt-7">
                    {{--<div class="min-h-180px w-100 rounded">--}}
                        @if($meeting->logo)
                            <img class="w-100 rounded" height="180px" alt="{{$meeting->title}}" src="{{$meeting->logo}}">
                        @else
                        <img class=" w-100 rounded" height="180px" alt="{{$meeting->title}}" src="/assets/media/stock-600x400/img-70.jpg">
                        @endif
                    {{--</div>--}}
                ...
                <!--begin::Name-->
                <div class="my-2">
                    <a href="{{route('PublicClass',$meeting->hash)}}" class="text-dark font-weight-bold text-hover-primary font-size-h4">{{$meeting->title}}</a>
                </div>
                <!--end::Name-->
                <!--begin::Label-->
                ...
                <!--begin::Buttons-->
                <div class="mt-9 mb-6">
                    <a href="{{route('PublicClass',$meeting->hash)}}" class="btn btn-light-success btn-pill mx-2">
                        @lang('info.view')
                    </a>
