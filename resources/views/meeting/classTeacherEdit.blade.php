...
@section('title') @lang('info.addTeacher') | @endsection
@section('subheader') @lang('info.addTeacher')  @endsection
@section('panelContent')
    ...
    <div class="col-md-6">
        <div class="card card-custom gutter-b">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">@lang('info.otherOfTeacher')</h3>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">@lang('info.addNewTeacher')</h5>
...
@section('footerScript')
    <script>
        function removeFromClass(hash,id){
            ...
            xmlhttp.open("GET","{{route('changeTeacher',['id'=>$meet->hash,'action'=>'remove'])}}?client="+id,true);
            xmlhttp.send();
        }
        function addToClass(hash,id){
            ...
            xmlhttp.open("GET","{{route('changeTeacher',['id'=>$meet->hash,'action'=>'add'])}}?client="+id,true);
            xmlhttp.send();
        }
        function checkEmpty() {
